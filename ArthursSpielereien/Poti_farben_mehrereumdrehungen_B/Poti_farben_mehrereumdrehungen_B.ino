...
float faktor;
uint32_t Color0 = pixels.Color(0, 0, 4);
uint32_t Color1 = pixels.Color(12, 12, 0);
uint32_t Color2 = pixels.Color(10, 5, 0);
uint32_t Color3 = pixels.Color(12, 0, 0);
uint32_t Color4 = pixels.Color(11, 0, 6);
uint32_t Color5 = pixels.Color(4, 0, 9);
uint32_t Color6 = pixels.Color(0, 0, 9);
